...
import { Users, LayoutGrid, MapPin, Trophy, Phone } from 'lucide-react'
...
export function CampeonatoDetailsModal({
  ...
  const telefoneFormatado = campeonato.telefone
    ? `${campeonato.phoneCode ?? ''} ${campeonato.telefone}`.trim()
    : null
  ...
  return (
    ...
    >
      ...
      ">
        ...
        {/* Localização + Telefone lado a lado */}
        <div className="grid grid-cols-2 gap-2 sm:gap-2.5">
