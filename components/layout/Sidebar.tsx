  ...
  return (
    <>
      ...
      <Button
        ...
        className="lg:hidden fixed top-4 right-4 z-50 shadow-lg p-2!"
      >
        {''}
      </Button>
      ...
      `}>
        ...
        <nav className="flex-1 overflow-y-auto overscroll-contain py-4 px-3">
          ...
          {/* Ação rápida — Link do Next.js, não usa Button */}
          <div className="mt-6">
            <h2 className="px-3 mb-2 text-[10px] font-semibold text-gray-400 uppercase tracking-wider">
              AÇÕES RÁPIDAS
            </h2>
        ...
        <div className="border-t border-gray-200 p-3">
          ...
          >
            ...
            <Icon
              icon={ChevronDown}
              size={16}
              className={`text-gray-400 transition-transform shrink-0 ${userMenuOpen ? 'rotate-180' : ''}`}
            />
          </Button>
