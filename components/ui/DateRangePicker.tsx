...
export function DateRangePicker({
  ...
  return (
    <div className="w-full">
      ...
      {/* Trigger — mesmos estilos do Input.tsx */}
      <div
        role="button"
      ...
      <Modal isOpen={open} onClose={() => setOpen(false)} size="sm" header={modalHeader} footer={modalFooter}>
        {/* Navegação mês */}
            ...
            return (
              <div key={i} className={[
                ...
                <button
                  ...
                  onMouseEnter={() => startDate && !endDate && setHovered(d.iso)}
